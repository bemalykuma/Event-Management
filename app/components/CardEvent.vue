...
import { MapPin, Users, Infinity as InfinityIcon } from '@lucide/vue'
...
<template>
    <div class="bg-white rounded-[20px] border-2 border-black w-full max-w-55 p-3 flex flex-col">
        <div>
            <div class="w-full aspect-3/4 bg-gray-200 rounded-[10px] overflow-hidden">
                <img class="w-full h-full rounded-[10px] object-cover" :src="props.event.imageUrl ??
        ...
        <div class="flex-1 flex flex-col justify-end">
            ...
            <div class="flex items-center gap-1 mt-1 text-xs flex-row" :class="props.event.registeredCount === props.event.maxParticipants
                ? 'text-red-500'
                : 'text-green-500'
                ">
                <Users class="w-4 h-4" />
